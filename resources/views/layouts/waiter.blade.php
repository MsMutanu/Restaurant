...
<head>
  ...
  <style>
    ...
    overflow: hidden; /* Hide image overflow for circular shape */
}

.menu-img {
    width: 100%;
    height: 100%;
    object-fit: cover; /* Scale and crop the image to fit the circular container */
}
...
<body>
 ...
 <!-- Preloader -->
  ...
  @include('layouts.waiter.partials.header')



    @include('layouts.waiter.partials.sidebar')
