...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('kitchen.index') }}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Kitchen Dashboard</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('kitchen.orders.incoming') }}" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('kitchen.orders.inprogress') }}" class="nav-link">
                                <i class="nav-icon far fa-circle"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('kitchen.orders.ready') }}" class="nav-link">
                                <i class="nav-icon far fa-circle"></i>
